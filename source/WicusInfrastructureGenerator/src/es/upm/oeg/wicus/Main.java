...
import es.upm.oeg.wicus.utils.ConfigValues;
...
public class Main {
	...
	private static String NONE_SVA_FOUND_MSG = "NOT_SVA_FOUND";
	...
	private static String FG_USER ="root";


	private static String DEST_COMMAND_PATH = "/home/wf/";   
...
//	    	System.out.println("Read:" + cw + " requires " + swrq);
	    ...
	    Map<String,ArrayList<String>> svaList = new HashMap<String,ArrayList<String>>();
	    ...
	    {     	
	    	...
	    	{
	    		System.err.println(NONE_SVA_FOUND_MSG + req);
	    		return;
	    	}
...
//	   System.out.println("*********************************\n");
	   ...
	   PrecipSpecGenerator precipGen = new  PrecipSpecGenerator(wfiModel, swcModel, svaModel);
	   String mergedSvasPrecip = precipGen.mergeMaxSVAandGenerateInfConfigurationPrecip(reqMaxSvaList,deployReqDg,cv.getCloudProviders());
	   ...
	   String mergedSvasPropagatedPrecip = precipGen.mergeMaxSVAandGenerateInfConfigurationPropagatedPrecip(wfMaxSvaList,deployWfDg,deployReqDg,cv.getCloudProviders());
...
//	}
	...
	private static Map<String, Map<String, Integer>> getCompatibleSva(Map<String, Digraph<String>> reqStackDiagraph,	Map<String, ArrayList<String>> svaList) 
	{
	    ...
	    while (itReq.hasNext()) 
	    {
	    	...
	    	Iterator<Entry<String, ArrayList<String>>> itSva = svaList.entrySet().iterator();
		    while (itSva.hasNext()) 
		    {
		    	Entry<String, ArrayList<String>> pairsSva = itSva.next();
		    	String sva = pairsSva.getKey().toString();
		    	ArrayList<String> stackList = (ArrayList<String>) pairsSva.getValue();
	...
	private static Map<String, Map<String, Integer>> getCompatibleSvaPropagated(Map<String, ArrayList<String>> wfPropReqs, Map<String, Digraph<String>> reqStackDiagraph,Map<String, ArrayList<String>> svaList) 
	{
	...
	private static int getDigraphAndStackIntersection(Digraph<String> dg,ArrayList<String> stackList) 
	{
		int intCount = 0;
	...
	private static Map<String, Digraph<String>> substractStackFromReqDg(Map<String, String> reqMaxSvaList, Map<String, Digraph<String>> reqStackDigraph,	Map<String, ArrayList<String>> svaList) 
	{
	    ...
	    while (reqMaxSvaListIt.hasNext()) 
	    {
	    	...
	    	ArrayList<String> svaStacks = svaList.get(maxSva);
	...
	private static Map<String, LinkedHashMap<String, Digraph<String>>> substractStackFromWfReqDg(Map<String, String> wfMaxSvaList, Map<String, ArrayList<String>> propagatedWfReqs, Map<String, Digraph<String>> reqStackDigraph,	Map<String, ArrayList<String>> svaList) 
	{
	    ...
	    while (wfMaxSvaListIt.hasNext()) 
	    {
	    	...
	    	for(String req : wfReqs)
	    	{
		    	...
		    	System.out.println("----->>>ADDING:" + req + " to " + wf);
